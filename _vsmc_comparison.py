...
test3_vsmc = anndata.AnnData(X=test3[test3.obs['leiden_r05'].isin(['0', '1', '2', '4', '8'])].layers['counts'], obs=test3[test3.obs['leiden_r05'].isin(['0', '1', '2', '4', '8'])].obs, var=test3[test3.obs['leiden_r05'].isin(['0', '1', '2', '4', '8'])].var)
...
test3_vsmc.var['highly_variable'].value_counts() # 2,612 ==> 2021-08-20, # 2,941 ==> 2021-09-28
...
#sc.pl.pca_variance_ratio(test3_vsmc, n_pcs=100)
...
sc.pl.umap(test3_vsmc, color=['vsmc_leiden_r05', 'vsmc_leiden_r10', 'leiden_r05', 'batch'], add_outline=False, legend_loc='right margin', size=50, color_map=cmap, ncols=4)

test3_vsmc.uns['batch_colors'] = ['#689aff', '#fdbf6f', '#b15928']
import magic
test3_vsmc_MAGIC = test3_vsmc.copy()
test3_vsmc_MAGIC.X = test3_vsmc.layers['scran_log1p']
test3_vsmc_MAGIC = magic.MAGIC().fit_transform(test3_vsmc_MAGIC)

test3_vsmc.layers['magic'] = test3_vsmc_MAGIC.X
